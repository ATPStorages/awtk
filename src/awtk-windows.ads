...
package AWTK.Windows is
   ...
   type Window_Callback_Message is
     (UNKNOWN,
      ...
      UAH_DESTROY_WINDOW,
      UAH_OPEN_MENU,
      UAH_MEASURE_MENU_ITEM,
      MOUSE_MOVED_NON_CLIENT,
      LEFT_MOUSE_DOWN_NON_CLIENT,
      LEFT_MOUSE_UP_NON_CLIENT,
      RIGHT_MOUSE_DOWN_NON_CLIENT,
      RIGHT_MOUSE_UP_NON_CLIENT,
      KEY_DOWN,
      KEY_UP,
      CHARACTER_DOWN,
      SYSTEM_KEY_DOWN,
      SYSTEM_KEY_UP,
      SYSTEM_MODIFIED_CHARACTER_DOWN,
      SYSTEM_COMMAND,
      MENU_OPENING,
      SUBMENU_OPENING,
      MENU_ITEM_SELECTED,
      MENU_MISC_CHRACTER_DOWN,
      MENU_GOING_IDLE,
      SUBMENU_CLOSED,
      CURSOR_MOVED,
   ...
   for Window_Callback_Message use
     (UNKNOWN                          => 16#00_00#,
      ...
      CLOSING                          => 16#00_10#,
      RESTORE_POSITION_SIZE            => 16#00_13#,
      ...
      SYNCHRONIZE_PAINT                => 16#00_88#,
      UAH_DESTROY_WINDOW               => 16#00_90#,
      UAH_OPEN_MENU                    => 16#00_93#,
      UAH_MEASURE_MENU_ITEM            => 16#00_94#,
      MOUSE_MOVED_NON_CLIENT           => 16#00_A0#,
      LEFT_MOUSE_DOWN_NON_CLIENT       => 16#00_A1#,
      LEFT_MOUSE_UP_NON_CLIENT         => 16#00_A2#,
      RIGHT_MOUSE_DOWN_NON_CLIENT      => 16#00_A4#,
      RIGHT_MOUSE_UP_NON_CLIENT        => 16#00_A5#,
      KEY_DOWN                         => 16#01_00#,
      KEY_UP                           => 16#01_01#,
      CHARACTER_DOWN                   => 16#01_02#,
      SYSTEM_KEY_DOWN                  => 16#01_04#,
      SYSTEM_KEY_UP                    => 16#01_05#,
      SYSTEM_MODIFIED_CHARACTER_DOWN   => 16#01_06#,
      SYSTEM_COMMAND                   => 16#01_12#,
      MENU_OPENING                     => 16#01_16#,
      SUBMENU_OPENING                  => 16#01_17#,
      MENU_ITEM_SELECTED               => 16#01_1F#,
      MENU_MISC_CHRACTER_DOWN          => 16#01_20#,
      MENU_GOING_IDLE                  => 16#01_21#,
      SUBMENU_CLOSED                   => 16#01_25#,
      ...
      ENTERED_MOVING_SIZING_WINDOW     => 16#02_31#,
      STOPPED_MOVING_SIZING_WINDOW     => 16#02_32#,
      DRAG_N_DROPPED_FILE              => 16#02_33#,
